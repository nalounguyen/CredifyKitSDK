...
#ifndef CREDIFYKIT_SWIFT_H
#define CREDIFYKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CredifyKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC10CredifyKit25SkyFloatingLabelTextField")
...
SWIFT_CLASS("_TtC10CredifyKit33SkyFloatingLabelTextFieldWithIcon")
...
@interface UINavigationController (SWIFT_EXTENSION(CredifyKit))
